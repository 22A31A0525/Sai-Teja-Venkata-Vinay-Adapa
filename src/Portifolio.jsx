...
const CertificateIcon = () => (
  ...
  >
    ...
    <path d="M10.5 15.5 8 13l-2.5 2.5" />
  ...
  <div className="relative bg-gray-900/50 p-6 rounded-xl border border-white/10 overflow-hidden group transition-all duration-300 hover:border-cyan-400/50 hover:scale-[1.02]">
    ...
    <div className="flex flex-wrap gap-2 mb-4">
      {tech.map((t) => (
        <span
          key={t}
          className="text-xs bg-gray-700/50 text-cyan-300 py-1 px-2 rounded-full"
        >
          {t}
        </span>
      ))}
  ...
  const projectData = [
    {
      ...
      description:
        "A full-stack campus recruitment platform built with Java and Spring Boot, featuring dedicated dashboards for students, officers, and recruiters.",
      tech: ["Java", "Spring Boot", "React", "PostgreSQL"],
      githubUrl: "https://github.com/CareerNexus-Pragati-Engineering-College",
      has: true,
      liveUrl: "https://carrernexus-c413a.web.app/",
    },
    {
      title: "DevBridge IDE",
      role: "Individual Contributor",
      description:
        "A collaborative code editor with real-time synchronization using WebSockets, JWT for security, and a React-based frontend.",
      tech: ["Java", "Spring Boot", "WebSockets", "React", "JWT"],
      githubUrl: "https://github.com/22A31A0525/DevBridgeIde",
      has: true,
      liveUrl: "https://dev-bridge-ide.vercel.app/",
    },
    {
      title: "DSA Showcase",
      role: "Personal Project",
      description:
        "A collection of projects implementing key Data Structures and Algorithms in Java, focusing on performance and problem-solving.",
      tech: ["Java", "DSA", "Algorithms"],
      githubUrl: "https://github.com/22A31A0525/DSA-Projects",
      has: false,
    },
    {
      title: "Now-Weather",
      ...
      description:
        "A dynamic weather app that provides real-time data, location mapping, and an adaptive background that changes based on the current weather.",
      tech: ["React", "REST APIs", "Mapping SDK"],
      githubUrl: "https://github.com/22A31A0525/Now-Weather",
      liveUrl: "https://saitejavenkat.github.io/Now-Weather/",
    },
    {
      title: " Multi-Profile Browser Automation Script",
      role: "Personal Project",
      description:
      ...
      tech: ["Python", "PyautoGui", "Automation", "os"],
      githubUrl:
        "https://github.com/22A31A0525/Automated-Browser-Tasks/tree/main",
      has: false,
    },
  ];
      ...
      >
        ...
        <div className="relative bg-gray-900/50 p-6 rounded-xl border border-white/10 overflow-hidden group transition-all duration-300 hover:border-violet-400/50 mb-6">
          ...
          <ul className="list-disc list-inside text-gray-400 text-sm space-y-1 mb-4">
            <li>
              Developing a production-grade browser extension using React.js and
              modern JavaScript, leveraging Chrome Extension APIs.
            </li>
            <li>
              Utilizing Chrome APIs (such as storage, runtime messaging, and
              tabs) to enable inter-component communication and extension
              functionality.
            </li>
            <li>
              Improving extension performance, handling edge cases, and
              debugging issues across different browser environments.
            </li>
          </ul>
        </div>
        ...
        <div className="relative bg-gray-900/50 p-6 rounded-xl border border-white/10 overflow-hidden group transition-all duration-300 hover:border-violet-400/50">
          ...
          <ul className="list-disc list-inside text-gray-400 text-sm space-y-1 mb-4">
            <li>
              Designed and implemented an OCR pipeline to extract and validate
              data from scanned cheques.
            </li>
            <li>
              Achieved over 99% data accuracy by developing a data validation
              module with PostgreSQL.
            </li>
            <li>
              Contributed to a 15% increase in recognition accuracy across
              different cheque formats.
            </li>
          </ul>
          <button
            onClick={() => setSelectedImg(infosysCertificateImg)}
            className="inline-flex items-center gap-2 text-sm text-violet-300 hover:text-white transition-colors font-semibold"
          >
...
const TabButton = ({ children, isSelected, onSelect }) => (
  <button
    className={`relative w-full py-3 px-4 text-sm sm:text-base font-semibold transition-colors duration-300 ${isSelected ? "text-white" : "text-gray-400 hover:text-white"}`}
    onClick={onSelect}
  >
    {children}
    {isSelected && (
...
export default function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      className=" min-h-52 max-h-auto w-full flex flex-col items-center justify-center py-20 px-4 overflow-hidden"
    >
      <div className="w-full max-w-4xl mx-auto">
        <AnimatedSectionTitle text="Portfolio" />
        <p className="max-w-2xl mx-auto mt-4 mb-12 text-gray-300 text-center">
          Explore my journey through projects, professional experience,
        ...
        <div className="relative flex justify-center border border-white/10 rounded-lg bg-gray-900/30 backdrop-blur-sm mb-12">
          ...
          <TabButton
            isSelected={selected === "certificates"}
            onSelect={() => setSelected("certificates")}
          >
            Certificates
          </TabButton>
          <TabButton
            isSelected={selected === "techStack"}
            onSelect={() => setSelected("techStack")}
          >
            Tech Stack
          </TabButton>
        </div>
        <div className="w-full min-h-[300px] flex items-start justify-center">
          <AnimatePresence mode="wait">{sections[selected]}</AnimatePresence>
        </div>
      </div>
    </section>
  );
